...
export function Footer() {
  return (
    <footer className="w-full border-t border-border bg-background/80 backdrop-blur-lg flex flex-col pt-12 pb-6 px-6 relative z-10 mt-auto transition-all duration-300">
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-10 border-b border-border pb-8 mb-6">

        {/* Central Gov Portals */}
        <div>
          <h3 className="text-foreground font-bold text-lg mb-4 flex items-center">
            <span className="w-2 h-2 rounded-full bg-[var(--neon-blue)] shadow-[0_0_8px_var(--neon-blue)] mr-3"></span>
            Central Government of India
          </h3>
          <ul className="space-y-3">
            <li>
              <a href="https://morth.nic.in/" target="_blank" rel="noopener noreferrer" className="text-muted hover:text-[var(--neon-blue)] transition-colors flex items-center group text-sm">
      ...
      {/* Disclaimer */}
      <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row justify-between items-center text-xs text-muted">
        <p className="mb-6 md:mb-0 max-w-3xl text-center md:text-left leading-relaxed">
